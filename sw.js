...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-3d9ab6","is-html-3d9ab6","is-jsdelivr-3d9ab6","is-gtm-3d9ab6","is-gravatar-3d9ab6","is-theme-3d9ab6","is-json-3d9ab6"];
      return Promise.all(
        names
