...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-d821dc","is-html-d821dc","is-jsdelivr-d821dc","is-gtm-d821dc","is-gravatar-d821dc","is-theme-d821dc","is-json-d821dc"];
      return Promise.all(
        names
