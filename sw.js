...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-691a13","is-html-691a13","is-jsdelivr-691a13","is-gtm-691a13","is-gravatar-691a13","is-theme-691a13","is-json-691a13"];
      return Promise.all(
        names
