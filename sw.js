...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-7591b8","is-html-7591b8","is-jsdelivr-7591b8","is-gtm-7591b8","is-gravatar-7591b8","is-theme-7591b8","is-json-7591b8"];
      return Promise.all(
        names
