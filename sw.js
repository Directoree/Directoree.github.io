...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-00c7b9","is-html-00c7b9","is-jsdelivr-00c7b9","is-gtm-00c7b9","is-gravatar-00c7b9","is-theme-00c7b9","is-json-00c7b9"];
      return Promise.all(
        names
