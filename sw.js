...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0acb01","is-html-0acb01","is-jsdelivr-0acb01","is-gtm-0acb01","is-gravatar-0acb01","is-theme-0acb01","is-json-0acb01"];
      return Promise.all(
        names
