...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-d1a4e9","is-html-d1a4e9","is-jsdelivr-d1a4e9","is-gtm-d1a4e9","is-gravatar-d1a4e9","is-theme-d1a4e9","is-json-d1a4e9"];
      return Promise.all(
        names
