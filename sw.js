...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-d1afc0","is-html-d1afc0","is-jsdelivr-d1afc0","is-gtm-d1afc0","is-gravatar-d1afc0","is-theme-d1afc0","is-json-d1afc0"];
      return Promise.all(
        names
