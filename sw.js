...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-fa4c68","is-html-fa4c68","is-jsdelivr-fa4c68","is-gtm-fa4c68","is-gravatar-fa4c68","is-theme-fa4c68","is-json-fa4c68"];
      return Promise.all(
        names
