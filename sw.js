...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-21fb8d","is-html-21fb8d","is-jsdelivr-21fb8d","is-gtm-21fb8d","is-gravatar-21fb8d","is-theme-21fb8d","is-json-21fb8d"];
      return Promise.all(
        names
