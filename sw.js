...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f86d68","is-html-f86d68","is-jsdelivr-f86d68","is-gtm-f86d68","is-gravatar-f86d68","is-theme-f86d68","is-json-f86d68"];
      return Promise.all(
        names
