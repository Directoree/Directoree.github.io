...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-36c7ce","is-html-36c7ce","is-jsdelivr-36c7ce","is-gtm-36c7ce","is-gravatar-36c7ce","is-theme-36c7ce","is-json-36c7ce"];
      return Promise.all(
        names
