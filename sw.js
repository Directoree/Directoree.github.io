...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0fc39d","is-html-0fc39d","is-jsdelivr-0fc39d","is-gtm-0fc39d","is-gravatar-0fc39d","is-theme-0fc39d","is-json-0fc39d"];
      return Promise.all(
        names
