...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-1989f5","is-html-1989f5","is-jsdelivr-1989f5","is-gtm-1989f5","is-gravatar-1989f5","is-theme-1989f5","is-json-1989f5"];
      return Promise.all(
        names
