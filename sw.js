...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-525aeb","is-html-525aeb","is-jsdelivr-525aeb","is-gtm-525aeb","is-gravatar-525aeb","is-theme-525aeb","is-json-525aeb"];
      return Promise.all(
        names
