...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-dee0aa","is-html-dee0aa","is-jsdelivr-dee0aa","is-gtm-dee0aa","is-gravatar-dee0aa","is-theme-dee0aa","is-json-dee0aa"];
      return Promise.all(
        names
