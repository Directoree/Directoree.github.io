...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-31e635","is-html-31e635","is-jsdelivr-31e635","is-gtm-31e635","is-gravatar-31e635","is-theme-31e635","is-json-31e635"];
      return Promise.all(
        names
