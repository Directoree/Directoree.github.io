...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-496c04","is-html-496c04","is-jsdelivr-496c04","is-gtm-496c04","is-gravatar-496c04","is-theme-496c04","is-json-496c04"];
      return Promise.all(
        names
