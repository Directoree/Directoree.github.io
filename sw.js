...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e97bf7","is-html-e97bf7","is-jsdelivr-e97bf7","is-gtm-e97bf7","is-gravatar-e97bf7","is-theme-e97bf7","is-json-e97bf7"];
      return Promise.all(
        names
