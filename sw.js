...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ce9aa3","is-html-ce9aa3","is-jsdelivr-ce9aa3","is-gtm-ce9aa3","is-gravatar-ce9aa3","is-theme-ce9aa3","is-json-ce9aa3"];
      return Promise.all(
        names
