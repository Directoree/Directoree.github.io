...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-243c67","is-html-243c67","is-jsdelivr-243c67","is-gtm-243c67","is-gravatar-243c67","is-theme-243c67","is-json-243c67"];
      return Promise.all(
        names
