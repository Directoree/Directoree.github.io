...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e6ecaa","is-html-e6ecaa","is-jsdelivr-e6ecaa","is-gtm-e6ecaa","is-gravatar-e6ecaa","is-theme-e6ecaa","is-json-e6ecaa"];
      return Promise.all(
        names
