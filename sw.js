...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0c3bf3","is-html-0c3bf3","is-jsdelivr-0c3bf3","is-theme-0c3bf3","is-json-0c3bf3"];
      return Promise.all(
        names
