...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b716d3","is-html-b716d3","is-jsdelivr-b716d3","is-gtm-b716d3","is-gravatar-b716d3","is-theme-b716d3","is-json-b716d3"];
      return Promise.all(
        names
