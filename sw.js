...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-3565b6","is-html-3565b6","is-jsdelivr-3565b6","is-gtm-3565b6","is-gravatar-3565b6","is-theme-3565b6","is-json-3565b6"];
      return Promise.all(
        names
