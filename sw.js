...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6be9eb","is-html-6be9eb","is-jsdelivr-6be9eb","is-gtm-6be9eb","is-gravatar-6be9eb","is-theme-6be9eb","is-json-6be9eb"];
      return Promise.all(
        names
