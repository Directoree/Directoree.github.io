...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-a5086f","is-html-a5086f","is-jsdelivr-a5086f","is-gtm-a5086f","is-gravatar-a5086f","is-theme-a5086f","is-json-a5086f"];
      return Promise.all(
        names
