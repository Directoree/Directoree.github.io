...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f455d2","is-html-f455d2","is-jsdelivr-f455d2","is-gtm-f455d2","is-gravatar-f455d2","is-theme-f455d2","is-json-f455d2"];
      return Promise.all(
        names
