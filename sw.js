...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-d900f4","is-html-d900f4","is-jsdelivr-d900f4","is-gtm-d900f4","is-gravatar-d900f4","is-theme-d900f4","is-json-d900f4"];
      return Promise.all(
        names
