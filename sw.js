...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-af37f8","is-html-af37f8","is-jsdelivr-af37f8","is-gtm-af37f8","is-gravatar-af37f8","is-theme-af37f8","is-json-af37f8"];
      return Promise.all(
        names
