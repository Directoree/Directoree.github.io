...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-cf3291","is-html-cf3291","is-jsdelivr-cf3291","is-gtm-cf3291","is-gravatar-cf3291","is-theme-cf3291","is-json-cf3291"];
      return Promise.all(
        names
