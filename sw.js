...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-c78fbf","is-html-c78fbf","is-jsdelivr-c78fbf","is-gtm-c78fbf","is-gravatar-c78fbf","is-theme-c78fbf","is-json-c78fbf"];
      return Promise.all(
        names
