...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-7758e8","is-html-7758e8","is-jsdelivr-7758e8","is-gtm-7758e8","is-gravatar-7758e8","is-theme-7758e8","is-json-7758e8"];
      return Promise.all(
        names
