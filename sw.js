...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-794d6e","is-html-794d6e","is-jsdelivr-794d6e","is-theme-794d6e","is-json-794d6e"];
      return Promise.all(
        names
