...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-feba01","is-html-feba01","is-jsdelivr-feba01","is-gtm-feba01","is-gravatar-feba01","is-theme-feba01","is-json-feba01"];
      return Promise.all(
        names
