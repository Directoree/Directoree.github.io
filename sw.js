...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-67a699","is-html-67a699","is-jsdelivr-67a699","is-gtm-67a699","is-gravatar-67a699","is-theme-67a699","is-json-67a699"];
      return Promise.all(
        names
