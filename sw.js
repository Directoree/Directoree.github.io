...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-adb8b6","is-html-adb8b6","is-jsdelivr-adb8b6","is-gtm-adb8b6","is-gravatar-adb8b6","is-theme-adb8b6","is-json-adb8b6"];
      return Promise.all(
        names
