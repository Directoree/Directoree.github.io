...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-85bdbf","is-html-85bdbf","is-jsdelivr-85bdbf","is-gtm-85bdbf","is-gravatar-85bdbf","is-theme-85bdbf","is-json-85bdbf"];
      return Promise.all(
        names
