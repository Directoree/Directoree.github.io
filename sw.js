...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0dc165","is-html-0dc165","is-jsdelivr-0dc165","is-gtm-0dc165","is-gravatar-0dc165","is-theme-0dc165","is-json-0dc165"];
      return Promise.all(
        names
