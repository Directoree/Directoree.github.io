...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-257fb2","is-html-257fb2","is-jsdelivr-257fb2","is-gtm-257fb2","is-gravatar-257fb2","is-theme-257fb2","is-json-257fb2"];
      return Promise.all(
        names
