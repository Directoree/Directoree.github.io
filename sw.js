...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-15c507","is-html-15c507","is-jsdelivr-15c507","is-theme-15c507","is-json-15c507"];
      return Promise.all(
        names
