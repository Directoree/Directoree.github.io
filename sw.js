...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-30037a","is-html-30037a","is-jsdelivr-30037a","is-gtm-30037a","is-gravatar-30037a","is-theme-30037a","is-json-30037a"];
      return Promise.all(
        names
