...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6baac1","is-html-6baac1","is-jsdelivr-6baac1","is-theme-6baac1","is-json-6baac1"];
      return Promise.all(
        names
