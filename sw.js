...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-cc5c3b","is-html-cc5c3b","is-jsdelivr-cc5c3b","is-gtm-cc5c3b","is-gravatar-cc5c3b","is-theme-cc5c3b","is-json-cc5c3b"];
      return Promise.all(
        names
