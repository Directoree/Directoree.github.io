...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-32352c","is-html-32352c","is-jsdelivr-32352c","is-gtm-32352c","is-gravatar-32352c","is-theme-32352c","is-json-32352c"];
      return Promise.all(
        names
