...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9c0b1b","is-html-9c0b1b","is-jsdelivr-9c0b1b","is-theme-9c0b1b","is-json-9c0b1b"];
      return Promise.all(
        names
