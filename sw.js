...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9c788b","is-html-9c788b","is-jsdelivr-9c788b","is-gtm-9c788b","is-gravatar-9c788b","is-theme-9c788b","is-json-9c788b"];
      return Promise.all(
        names
