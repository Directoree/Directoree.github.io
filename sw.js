...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-187d6d","is-html-187d6d","is-jsdelivr-187d6d","is-gtm-187d6d","is-gravatar-187d6d","is-theme-187d6d","is-json-187d6d"];
      return Promise.all(
        names
