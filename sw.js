...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-a1d01e","is-html-a1d01e","is-jsdelivr-a1d01e","is-gtm-a1d01e","is-gravatar-a1d01e","is-theme-a1d01e","is-json-a1d01e"];
      return Promise.all(
        names
