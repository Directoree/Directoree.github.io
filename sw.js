...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-5dc0d7","is-html-5dc0d7","is-jsdelivr-5dc0d7","is-gtm-5dc0d7","is-gravatar-5dc0d7","is-theme-5dc0d7","is-json-5dc0d7"];
      return Promise.all(
        names
